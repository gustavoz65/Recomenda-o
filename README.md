# Projeto de Recomendações de Filmes

Este é um projeto simples para estudos, que utiliza dados de filmes e avaliações para criar recomendações baseadas em heurísticas como total de votos e notas médias.
...
- Cálculo do total de votos por filme.
- Cálculo da nota média dos filmes.
- Filtragem de filmes com base em critérios como número mínimo de votos.
